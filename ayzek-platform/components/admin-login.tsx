      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-card to-muted p-4 dark">
        ...
        <Card className="w-full max-w-md bg-card/50 border-primary/20">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-2xl font-display bg-ayzek-gradient bg-clip-text text-transparent">
              Yönetici Erişimi
            </CardTitle>
            <CardDescription>AYZEK yönetici paneline erişmek için giriş yapın</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="admin@ayzek.community"
                  required
            ...
            <div className="mt-6 text-center">
              <p className="text-xs text-muted-foreground">Demo bilgileri: admin@ayzek.community / admin123</p>
            </div>
          </CardContent>
        </Card>
      </div>
