...
export default function EventsPage() {
  ...
  const handleEventSubmit = (e: React.FormEvent) => {
    ...
    console.log("Event suggestion submitted:", eventForm)
      ...
      <section className="py-16 px-4 relative overflow-hidden">
        ...
        <div className="container max-w-screen-xl mx-auto text-center relative z-10">
          <ScrollAnimation animation="fade-up">
            <h1 className="text-4xl md:text-6xl font-display font-bold mb-6 gradient-text">Topluluk Etkinlikleri</h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="1-2 hours">1-2 Saat</SelectItem>
                        <SelectItem value="half-day">Yarım Gün</SelectItem>
                        <SelectItem value="full-day">Tam Gün</SelectItem>
                        <SelectItem value="multi-day">Çok Günlü</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) => setEventForm({ ...eventForm, audience: value })}
                    >
                      <SelectTrigger>
                        <SelectValue placeholder="Hedef kitle seçin" />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectItem value="beginner">Başlangıç Seviyesi</SelectItem>
                        <SelectItem value="intermediate">Orta Seviye</SelectItem>
                        <SelectItem value="advanced">İleri Seviye</SelectItem>
                        <SelectItem value="all-levels">Tüm Seviyeler</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                </div>
        ...
        <div className="container max-w-screen-xl mx-auto">
          <div className="flex flex-col items-center space-y-6">
            ...
            <div className="flex items-center space-x-6">
              ...
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849.149 3.225 1.664 4.771 4.919 4.919 1.266.057 1.689-.07 4.849-.07 3.204 0 3.584-.012 4.849-.072 3.26-.149 4.771-1.699 4.919-4.92-.058-1.265-.073-1.689-.073-4.849 0-3.204.013-3.668.072-4.948.196-4.354-2.617-6.78-6.98-6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.149 4.354 2.617 6.78 6.979 6.98 1.281.057 1.69-.073 4.948-.073zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.149 4.354 2.617 6.78 6.979 6.98 1.281.057 1.69-.073 4.948-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z" />
                </svg>
              </a>
            </div>
