      ...
      <section className="py-8 sm:py-10 md:py-14 px-3 sm:px-4 relative overflow-hidden">
        <div className="absolute inset-0 opacity-5">
          <svg className="w-full h-full" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <pattern id="v-lines" width="12" height="8" patternUnits="userSpaceOnUse">
                <line x1="11" y1="0" x2="11" y2="8" stroke="currentColor" strokeWidth="1" />
              </pattern>
            </defs>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 md:gap-5 text-center">
            <ScrollAnimation animation="scale-up" delay={0}>
              <div className="hover-lift theme-transition rounded-lg p-4 sm:p-5 md:p-6 h-[110px] sm:h-[130px] md:h-[150px] flex flex-col items-center justify-center bg-purple-500/90 text-white shadow-lg">
                <div className="text-2xl sm:text-3xl font-display font-bold mb-0.5 animate-float">12+</div>
                <div className="text-white/90 text-xs sm:text-sm md:text-base">Proje Takımı</div>
              </div>
            </ScrollAnimation>
            <ScrollAnimation animation="scale-up" delay={100}>
              <div className="hover-lift theme-transition rounded-lg p-4 sm:p-5 md:p-6 h-[110px] sm:h-[130px] md:h-[150px] flex flex-col items-center justify-center bg-green-500/90 text-white shadow-lg">
                ...
                <div className="text-white/90 text-xs sm:text-sm md:text-base">Kazanılan Ödül</div>
              </div>
            </ScrollAnimation>
            <ScrollAnimation animation="scale-up" delay={200} className="order-4 md:order-none">
              <div className="hover-lift theme-transition rounded-lg p-4 sm:p-5 md:p-6 h-[110px] sm:h-[130px] md:h-[150px] flex flex-col items-center justify-center bg-purple-500/90 text-white shadow-lg">
                <div className="text-2xl sm:text-3xl font-display font-bold mb-0.5 animate-float" style={{ animationDelay: "1s" }}>
                  120+
                </div>
                <div className="text-white/90 text-xs sm:text-sm md:text-base">Geliştirici Üye</div>
              </div>
            </ScrollAnimation>
            <ScrollAnimation animation="scale-up" delay={300} className="order-3 md:order-none">
              <div className="hover-lift theme-transition rounded-lg p-4 sm:p-5 md:p-6 h-[110px] sm:h-[130px] md:h-[150px] flex flex-col items-center justify-center bg-green-500/90 text-white shadow-lg">
          ...
          <ScrollAnimation animation="fade-up">
            <div className="flex flex-col items-center space-y-3 sm:space-y-4">
              ...
              <div className="flex items-center space-x-4 sm:space-x-6">
                ...
                <a href="https://github.com/Ayzek-2022" className="text-muted-foreground hover:text-primary transition-colors">
                  <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="currentColor" viewBox="0 0 24 24">
