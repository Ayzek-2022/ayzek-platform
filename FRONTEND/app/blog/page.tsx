...
const blogStats = [
  { value: "15+", label: "Teknik Makale", color: "bg-purple-500/90" },
  { value: "1k+", label: "Okunma Sayısı", color: "bg-green-500/90" },
  { value: "15+", label: "Yazar", color: "bg-purple-500/90" },
  { value: "6", label: "Farklı Kategori", color: "bg-green-500/90" },
]
      ...
      <section className="py-8 sm:py-10 md:py-14 px-3 sm:px-4 relative overflow-hidden">
        <div className="absolute inset-0 opacity-5">
          <svg className="w-full h-full" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <pattern id="h-lines" width="8" height="12" patternUnits="userSpaceOnUse">
                <line x1="0" y1="11" x2="8" y2="11" stroke="currentColor" strokeWidth="1" />
              </pattern>
            </defs>
