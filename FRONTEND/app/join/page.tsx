            ...
            {benefits.map((benefit, index) => {
              ...
              return (
                <ScrollAnimation key={index} animation="scale-up" delay={index * 100}>
                  <Card
                    className="group hover:shadow-lg transition-all duration-300 hover:-translate-y-1 bg-black/80 backdrop-blur-sm border border-white/10 h-[250px] sm:h-[270px] md:h-[290px] flex flex-col"
                  >
                    <CardHeader className="text-center flex-shrink-0 p-3 sm:p-3.5 md:p-4">
                      <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 mx-auto mb-1.5 rounded-full bg-ayzek-gradient/10 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
